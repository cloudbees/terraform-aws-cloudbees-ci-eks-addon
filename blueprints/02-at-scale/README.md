...
- The Public Registry uses DockerHub (It requires an existing DockerHub Organization).
- The Private Registry uses AWS ECR (It requires an existing ECR Repository).
